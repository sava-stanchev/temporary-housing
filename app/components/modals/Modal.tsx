...
const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <>
      <div className="justify-center items-center lg:items-start flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70">
        <div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 m-auto">
          {/* CONTENT */}
          <div
            className={`my-6 translate duration-300 ${
